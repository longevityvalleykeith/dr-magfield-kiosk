 ...
 *
 * QUARANTINED 2026-09-02 (EV-8). This rail reaches Stripe and predates the K-1
 * money fence, so `app/rabbit-cup/page.tsx` only lazy-loads it when
 * NEXT_PUBLIC_RABBIT_CUP_ENABLED === 'true'. With the flag unset this module
 * lives in a chunk the page never requests. It is NOT deleted: retire vs
 * quarantine is Keith's door S-C.
 */
